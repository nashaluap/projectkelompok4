            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-4 px-lg-5 py-3 py-lg-0">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav ms-auto py-0 pe-4">
                        ...
                        <a href="/menuhanna" class="nav-item nav-link <?php echo e(Request::is('menuhanna') ? 'active' : ''); ?>" style="text-align: center"><br>Menu</a>
                        <a href="/abouthanna" class="nav-item nav-link <?php echo e(Request::is('abouthanna') ? 'active' : ''); ?>" style="text-align: center"><br>Tentang Hanna Catering</a>
                        <a href="/testimoni" class="nav-item nav-link <?php echo e(Request::is('testimoni') ? 'active' : ''); ?>" style="text-align: center"><br>Testimoni</a>
                ...
                <div class="container my-5 py-5">
                    <div class="row align-items-center g-5">
                        ...
                        <div class="col-lg-6 text-center text-lg-end overflow-hidden">
                            <img class="img-fluid" src="<?php echo e(asset('boostrap2/img/hanna1.png')); ?>" alt="">
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                ...
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s" src="<?php echo e(asset('boostrap2/img/about-3.jpg')); ?>"><br>
                                <br><h5>Kue Basah</h5>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                <div class="text-center">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s" src="<?php echo e(asset('boostrap2/img/snackbox.jpg')); ?>"><br>
                                <br><h5>Snack Box</h5>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                <div class="text-center">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s" src="<?php echo e(asset('boostrap2/img/nampan.jpg')); ?>"><br>
                                <br><h5>Kue Nampan</h5>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                <div class="text-center"> 
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s" src="<?php echo e(asset('boostrap2/img/tampan.jpg')); ?>"><br>
                                <br><h5>Kue Tampah</h5>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                <div class="text-center">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s" src="<?php echo e(asset('boostrap2/img/tumpeng.jpg')); ?>"><br>
                                <br><h5>Tumpeng</h5>
                    ...
                    <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                        <div class="service-item rounded pt-3">
                            <div class="p-4">
                                <div class="text-center">
                                <img class="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s" src="<?php echo e(asset('boostrap2/img/nasibox.jpg')); ?>"><br>
                                <br><h5>Nasi Box</h5>
                ...
                <div class="owl-carousel testimonial-carousel">
                    <div class="testimonial-item bg-transparent border rounded p-4">
                        ...
                        <div class="d-flex align-items-center">
                            <img class="img-fluid flex-shrink-0 rounded-circle" src="<?php echo e(asset('boostrap2/img/testimonial-1.jpg')); ?>" style="width: 50px; height: 50px;">
                            <div class="ps-3">
...
</html><?php /**PATH C:\xampp\htdocs\nashalu-project2\resources\views/v_index.blade.php ENDPATH**/ ?>
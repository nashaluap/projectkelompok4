            ...
            <div class="card border-penjualan">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo e($jumlahPesananBulanan ?? '0'); ?></div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-pendapatan">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                           <div class="h5 mb-0 font-weight-bold text-gray-800">Rp<?php echo e(number_format($pendapatanBulanan ?? 0, 0, ',', '.')); ?></div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-pesanan">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                           <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo e($totalPesanan ?? 0); ?></div>
                ...
                <div class="card-body">
                    <div class="text-center">
                        <img class="img-fluid px-3 px-sm-4 mt-3 mb-4" style="width: 25rem;"
                            src="<?php echo e(asset('template')); ?>/img/fotocafe.jpg" alt="...">
                    </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        if (calendarEl) {
            ...
            initialDate: '<?php echo e(\Carbon\Carbon::now()->toDateString()); ?>',
            events: [
             <?php if(isset($jadwalPengambilan) && $jadwalPengambilan->count() > 0): ?>
                <?php $__currentLoopData = $jadwalPengambilan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jadwal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    {
                        title: '<?php echo e($jadwal->nama_pemesan); ?> - <?php echo e(\Carbon\Carbon::parse($jadwal->tgl_pesanan)->format("H:i")); ?>',
                        start: '<?php echo e(\Carbon\Carbon::parse($jadwal->tgl_pesanan)->toDateString()); ?>T<?php echo e(\Carbon\Carbon::parse($jadwal->tgl_pesanan)->format("H:i:s")); ?>',
                        description: '<?php echo e($jadwal->alamat); ?>',
                        allDay: false
...
<script>
    ...
    const pendapatanBulanan = <?php echo json_encode($pendapatanBulan ?? [], 15, 512) ?>;
